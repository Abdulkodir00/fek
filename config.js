...
global.namebot = 'MikuBOT'
global.nameown = 'dims'


/*============== STAFF ==============*/
global.owner = [
  ['6283143092635', 'Dims', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'MikuBOT | By Dims' //Main Watermark
global.wm2 = 'MikuBot'
global.wm3 = 'MikuBOTV5 | By Dims'
global.botdate = `⻝ Tanggal: ${week} ${date}\n⻝ Waktu: ${wktuwib}`
global.bottime = `⻝ W A K T U : ${wktuwib}`
global.titlebot = `MikuBOT | ʙʏ ${global.nameown}`
global.author = 'MikuBot' 
global.packname = 'By MikuBot'
...
global.botintro = 'Hallo, Kenalin saya Mikubot Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh *KhrlMstfa✓* Saya di rilis pada tanggal\n🗓 ️_23/11/2022_'
